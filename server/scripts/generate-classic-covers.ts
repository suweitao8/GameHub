/**
 * 一次性脚本：为官方经典小游戏生成特色封面并写入 game.coverPath。
 *
 * 用法（build:server 后）：
...
const GENERATORS: Record<string, () => string> = {
  ...
  '太空入侵者': () => emojiCover('👾', '#101842', '#29154b', '太空入侵者', '守住防线 · 击退舰队'),
  '四子棋': () => emojiCover('🔴', '#17366d', '#1f66d1', '四子棋', '抢占列位 · 连成四子'),
  '黑白棋': () => emojiCover('⚫', '#134d36', '#0e2f24', '黑白棋', '夹住翻转 · 抢占角落'),
  '国际跳棋': () => emojiCover('♛', '#4a2630', '#28151c', '国际跳棋', '跳吃升王 · 策略对局'),
  '数独': () => emojiCover('🔢', '#173041', '#182735', '数独', '九宫推理 · 填满数字'),
  '记忆序列': () => emojiCover('🔆', '#302954', '#17152b', '记忆序列', '观察顺序 · 挑战记忆'),
  '青蛙过河': () => emojiCover('🐸', '#1d5c42', '#123c31', '青蛙过河', '穿越车流 · 借木渡河'),
  '泡泡龙': () => emojiCover('🫧', '#26346b', '#17173e', '泡泡龙', '同色三连 · 清空泡泡'),
  '纸牌 21 点': () => emojiCover('🃏', '#1a5b3f', '#103524', '纸牌 21 点', '要牌停牌 · 接近二十一'),
  '猜单词': () => emojiCover('🔤', '#41325e', '#221b34', '猜单词', '中文提示 · 找全字母')
}
