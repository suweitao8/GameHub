...
gamesRouter.get('/me/recommendations', authenticate, asyncMiddleware(listRecommendedGames))
gamesRouter.get('/me/level', authenticate, asyncMiddleware(getUserLevel))
gamesRouter.post('/me/level/daily-login', authenticate, asyncMiddleware(claimDailyLoginHandler))
...
gamesRouter.get('/:uuid/seo', gameUUIDValidator, cacheRoute(ROUTE_CACHE_LIFETIME.GAMES_DETAIL), asyncMiddleware(getGameSEO))
