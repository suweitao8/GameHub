...
assert(/\.wechat-message\.own \.wechat-bubble\s*\{[\s\S]*background: #95ec69;[\s\S]*color: #303133;/.test(discussTs), 'own discussion messages must use the light WeChat green background with black text')
