...
- 全站视觉参考 mydrama 浅色皮肤，统一为中性画布、白色内容层、深色墨阶和低饱和青绿色交互；收敛多彩占位、渐变和装饰性发光，同时保留真实游戏内容。
- 搜索框改为单层输入控件，热门搜索与联想作为独立面板显示；自动生成封面和窄屏页面也同步采用安静、清晰的浅色体验，详见[完整更新记录](docs/releases/release-notes.md)。
