...
- 全站视觉改为围绕 Logo 蓝 `#00aeec` 的清爽游戏平台风格，统一游戏中心、详情、社区、账户、登录注册和创作工作台的导航、卡片、表单与状态层级。
- 保留游戏封面多彩内容和粉色热门/提醒语义，统一主要行动、焦点反馈与窄屏触控尺寸；搜索框在桌面和移动端均保持单层边框，详见[完整更新记录](docs/releases/release-notes.md)。
