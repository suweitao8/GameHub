...
- [x] **Step 1: 添加共享字段和媒体 surface token**
...
- [x] **Step 3: 同步 skeleton 的密度和圆角**

让骨架封面、标题、作者的节奏与新卡片一致，避免加载态回到旧的松散灰块。

- [x] **Step 4: 运行客户端契约与客户端 lint**
...
- [x] **Step 1: 统一内容页 header、Tab 和 surface**
